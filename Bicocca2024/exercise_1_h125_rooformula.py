...
eff_h125 = ROOT.RooRealVar("eff_h125","The Higgs efficiency",0.25,0.00001,1.)
lumi = ROOT.RooRealVar("lumi","The CMS luminosity",24.8,0.00001,50.,"fb-1")
cross_h125 = ROOT.RooRealVar("cross_h125","The psi xsec",3.,0.,45.,"fb")

#Now define the number of psi events
Nh125 = ROOT.RooFormulaVar("Nh125","@0*@1*@2",ROOT.RooArgList(eff_h125,lumi,cross_h125))
