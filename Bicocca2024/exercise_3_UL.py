...
ws.var("cross_psi").setRange(0.,40.)  #this is mostly for plotting
...
ws.factory("Uniform::prior_psi(cross_psi)")
ws.factory("Uniform::prior_bkg(Nbkg)")
ws.factory("PROD::prior(prior_psi,prior_bkg)")
